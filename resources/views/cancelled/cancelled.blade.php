@extends('cancelled.layout')

@section('content')
<!-- Cancelled Reservations Header -->
<div class="container mt-4">
    <div class="row">
        <div class="col-lg-12 d-flex justify-content-between align-items-center">
            <h4 class="text-dark">Cancelled Reservations</h4>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="custom-table-container">
                <table id="cancelledTable" class="table table-striped table-hover text-center">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <form action="{{ route('reservations.send-cancelled-email', ['id' => $reservation->id]) }}" method="POST">
                                                @csrf
                                        ...
                                        <li>
                                            <form method="POST" action="{{ url('/reservations/restore/' . $reservation->id) }}">
                                                {{ method_field('PATCH') }}
                                                {{ csrf_field() }}
                                                <button type="submit" class="dropdown-item text-success" onclick="return confirm('Restore this cancelled reservation?')">
...
<script>
    $(document).ready(function() {
        let table = $('#cancelledTable').DataTable({
